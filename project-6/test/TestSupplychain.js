...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function buyItem() that allows a distributor to buy coffee", async() => {
        ...
        var balance = web3.toWei(0.05, "ether");
        const farmerBalanceBefore = await web3.eth.getBalance(originFarmerID);
        const txInfo = await supplyChain.buyItem(upc, {from: distributorID, value: balance});
        ...
        assert.equal(resultBufferTwo[8], distributorID, 'Error: Invalid consumer ID');

        assert.equal(farmerBalanceAfter - farmerBalanceBefore, productPrice);
    ...
    it("Testing smart contract function receiveItem() that allows a retailer to mark coffee received", async() => {
        ...
        assert.equal(resultBufferTwo[7], retailerID, 'Error: Invalid retailedID');
    ...
    it("Testing smart contract function purchaseItem() that allows a consumer to purchase coffee", async() => {
        ...
        assert.equal(resultBufferTwo[8], consumerID, 'Error: Invalid retailedID');
